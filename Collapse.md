...
(Тут персонажей много не в концепте этому место, явно.)
...
Сразу отмечу что атмосфера тут не такая как описана выше. Там глобальная для мира, тут другой мир и события сразу после дня Х. Мракобесие только началось.
